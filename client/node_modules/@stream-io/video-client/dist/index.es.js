...
// @generated message type with reflection information, may provide speed optimized methods
class AudioMediaRequest$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class VideoMediaRequest$Type extends MessageType {
    constructor() {
...
class DynascaleManager {
    ...
    constructor(call) {
        ...
        this.bindVideoElement = (videoElement, sessionId, trackType) => {
            ...
            const participant$ = this.call.state.participants$.pipe(map$1((participants) => participants.find((participant) => participant.sessionId === sessionId)), takeWhile((participant) => !!participant), distinctUntilChanged(), shareReplay({ bufferSize: 1, refCount: true }));
            /**
        ...
        this.bindAudioElement = (audioElement, sessionId, trackType) => {
            ...
            if (!participant || participant.isLocalParticipant)
                return;
            const participant$ = this.call.state.participants$.pipe(map$1((participants) => participants.find((p) => p.sessionId === sessionId)), takeWhile((p) => !!p), distinctUntilChanged(), shareReplay({ bufferSize: 1, refCount: true }));
